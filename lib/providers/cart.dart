...
//    db.addCartItem(CartItem(id: productId, productId: productId, title: title, quantity: 1, price: price, isNonInventory: isNonInventory, discount: discount, discountType: discountType, discountId: discountId));
//    db.isProductExist(productId).then((bool value){
//      if(value){
//        print('got the data item');
//      }else{
//        print('no data item');
//
//      }
